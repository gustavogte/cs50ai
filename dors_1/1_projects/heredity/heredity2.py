...
def load_data(filename):
    ...
    print("\nData: \n")
    print(data)
    posibilities = all_posibilities(data)
    print("posiblilities: ", posibilities[0:4], "total: ", posibilities[4]) 
    print()
...
## TODO GG not working for all cases
def all_posibilities(data:dict):
    # persons: all persons in dict
    persons = len(data)
    # mothers: all persons - itself or none
    mothers = len(data) - 1 + 1
    # same as mothers
    fathers = len(data)
    # trait have it or not  (True or False)
    traits = 2
    total = persons * (mothers * fathers * traits)

    return persons, mothers, fathers, traits, total   
...
def update(probabilities:dict, one_gene:set, two_genes:set, have_trait:set, p:float) -> None:
    ...
    for person in probabilities:
        ...
        print("set 2 genes", two_genes)
        print("set 1 gene", one_gene)
        print("set trait", have_trait)
        print(">>>>>>>>>>>>>>>>>>>>")
        print(person, "gene: ", probabilities[person]["gene"], p)
        print(person, "trait:", probabilities[person]["trait"], p)
        print()
        ...
        for person in probabilities:
            ...
            probabilities[person]["trait"][h_trait] += p
